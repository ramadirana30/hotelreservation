...
<h1 style="margin-top:200px; margin-left:100px;">Booking Room Meeting</h1>
<form action="meeting_proses.php?action=order" method="POST">
...
<div class="block">
<select name="jmeeting" onchange="meeting()" id="jmeeting" required>
<option></option>
...
<div class="block">
<select id="pilihmeeting" name="idmeeting" required>
<option></option>
</select>
</div>
...
$(document).ready(function(){
    ...
    function meeting(){
            ...
            $.ajax({
                url : "meeting_proses.php?action=getmeeting&&jenis="+jenis,
                type : "GET",
                dataType : "JSON",
