...
<form action="restaurant_proses.php?action=order" method="POST">
...
<div class="block">
<select name="jresto" id="jresto" required>
...
<div class="block">
<select id="pilihresto" name="pilihresto" required>
...
<div class="menu box"><textarea rows="5" cols="50" id="keterangan" name="keterangan" required></textarea></div>
<p style="color:black; text-align:left; margin-left:100px;  margin-bottom:10px; font-size:30px;">Tanggal Makan :</p>
<div class="block"><input type="date" class="input-res" id="tglmakan" name="tglmakan" required></div>
