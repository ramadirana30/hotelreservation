...
<h1 style="margin-top:200px; margin-left:100px;">Register</h1>
...
<div class="block"><input type="text" class="input-res" name="nama" required></div>
<p style="color:black; text-align:left; margin-left:100px;  margin-bottom:10px; font-size:30px;">Alamat :</p>
<div class="block"><input type="text" class="input-res" name="alamat" required></div>
