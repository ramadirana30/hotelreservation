...
<div class="row" >
    <div class="col-xs-12 col-sm-12 col-lg-12" style="background-color:white; height:200px; color : black; font-family : times new roman; font-size : 70px; text-align: center; margin-top : 150px;">BOOKNOW<hr style=" border: 2px solid black;"></div>
</div>
<div class="row" >
<div class="col-xs-4 col-sm-4 col-lg-4" style="background-color:white; height:950px;">
    <div class="card">
        <input type="checkbox" name="">
        <div class="toggle">+ </div>
        <div class="imgBx"><img width="100%" height="100%" src="img/roomm.jpg"></div>
        <div class="details">
            <h2>HOTEL ROOM</h2><br>
            <p>Kami memiliki 4 tipe kamar:</p>
            <br>
            <p>- Standard</p>
            <p>- Superior</p>
            <p>- Deluxe</p>
...
<br><center>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="roomt.php">BOOKING</a></button></center>
</div>
    <div class="col-xs-4 col-sm-4 col-lg-4" style="background-color:white; height:950px;">
    <div class="card">
        <input type="checkbox" name="">
        <div class="toggle">+ </div>
        <div class="imgBx"><img width="100%" height="100%" src="img/resto.jpg"></div>
        <div class="details">
            <h2>HOTEL RESTAURANT</h2><br>
            <p>Kami memiliki 2 tipe menu :</p>
            <br>
            <p>- Buffet (Breakfast, Lunch, Dinner)</p>
            <p>- Menu</p>
...
<br><center>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="restaurantt.php">BOOKING</a></button></center>
</div>
    <div class="col-xs-4 col-sm-4 col-lg-4" style="background-color:white; height:950px;">
    <div class="card">
        <input type="checkbox" name="">
        <div class="toggle">+ </div>
        <div class="imgBx"><img width="100%" height="100%" src="img/meetingroom.jpg"></div>
        <div class="details">
            <h2>HOTEL MEETING ROOM</h2><br>
            <p>Kami memiliki 2 tipe Meeting Room :</p>
            <br>
            <p>- Big</p>
            <p>- Small</p>
...
<br><center>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="meetingt.php">BOOKING</a></button></center>
</div>
</div>
<div class="row" >
...
<div class="logo"> <img style="margin-top:-60px;" width="80%" height="200%"src="img/milosku.png"></div>
    <nav class="active">
        ...
        <li><a href="homet.php">Home</a></li>
            ...
            <li style="margin-right:-85px;"><a href="login.php">Login</a></li>
</ul>
</nav>
