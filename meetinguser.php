...
<div class="main" id="section1"><a href="#section2"></a></div>
  ...
  <div class="row" >
    <div class="col-xs-12 col-sm-12 col-lg-12" style="background-color:white; height:200px; color : black; font-family : times new roman; font-size : 70px; text-align: center; margin-top : 200px;">MEETING ROOMS<hr style=" border: 2px solid black;"></div>
</div>
<div class="row">
<div class="col-xs-6 col-sm-6 col-lg-6"  style="height:900px;"> <img src="img/small.jpg" height="96%" width="100%"></div>
<div class="col-xs-6 col-sm-6 col-lg-6" ><p style="font-size : 70px; color : black; font-family : times new roman;">SMALL</p> 
<p style="font-size : 30px; color : black; font-family : times new roman;">
Ruang Meeting dengan tipe jenis small difasilitasi dengan :
<br> 
- Proyektor<br>
- Meja <br>
- Kursi <br>
- Layar <br>
- AC <br>
- Kapasitas untuk 20 Orang
</p>
<p style="color:red;">Harga : Rp. 2.500.000/Hari</p>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="meeting.php">BOOKING</a></button>
</div>
  </div>
  <div class="row">
<div class="col-xs-6 col-sm-6 col-lg-6" style="height:900px;"> <img src="img/big.jpg" height="96%" width="100%"></div>
<div class="col-xs-6 col-sm-6 col-lg-6" ><p style="font-size : 70px; color : black; font-family : times new roman;">BIG</p> 
<p style="font-size : 30px; color : black; font-family : times new roman;">
Ruang Meeting dengan tipe jenis small difasilitasi dengan :
<br> 
- Proyektor<br>
...
<p style="color:red;">Harga : Rp. 5.000.000/Hari</p>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="meeting.php">BOOKING</a></button>
</div>
  </div>
<div class="row" >
