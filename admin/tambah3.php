...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
                <h1 class="page-header">Tambah Data</h1><br>
                <form action="edit4.php?action=order" method="POST">
                <div class="text">Nama :</div>
  <input class="inputan" type="text" id="nama" name="nama" ><br>
...
<option></option>
  ...
  <div class="text">Checkin :
   <br></div>
   <input type="date" class="inputan"  id="checkin" name="checkin"><br>

  
  Checkout : <br>
  <input type="date" class="inputan" id="checkout" name="checkout" >
  <div class="text">
<br><br>
