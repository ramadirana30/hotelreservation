...
<body>
    ...
    <tr>
        <th>ID_Transaksi</th><th>Nama</th> <th>Kode Booking</th> <th>Harga</th> <th>Tanggal Bayar</th> <th>UPDATE</th> 
    </tr>
    <?php  
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a class='btn btn-success' href='edittr.php?id=$user_data[id_transaksi]'>Edit</a>  <a class='btn btn-success' href='deletetr.php?id=$user_data[id_transaksi]'>Delete</a></td></tr>";       
    }
    ?>
    </thead>
    </table>
...
<input type="button" onclick="location.href='tambahtr.php'" class="btn btn-success" value="TAMBAH TRANSAKSI"> <input type="button" onclick="location.href='laporan.php'" class="btn btn-success" value="CETAK">
