	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			while($d = mysqli_fetch_array($query)){
				?>
                <h1 class="page-header">Tambah Transaksi</h1><br>
                <form action="edittr2.php?action=order" method="POST">
  <div class="text">Nama :</div>
  <input class="inputan" type="text" id="nama" name="nama" value="<?= $d['nama']; ?>" required><br>
  <div class="text">Kode Booking :</div>
  <input class="inputan" type="text" id="kdbooking" name="kdbooking" required value="<?= $d['kd_booking']; ?>"><br>
  <div class="text">Tanggal Bayar :</div>
  <input class="inputan" type="date"  min="2019-01-01" max="2019-12-31" id="tglbayar" name="tglbayar" value="<?= $d['tgl_bayar']; ?>" required><br>
  <div class="text">Harga :</div>
  <input class="inputan" type="text" id="harga" name="harga" value="<?= $d['harga']; ?>" required><br>
<br><br>
