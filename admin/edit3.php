...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			while($d = mysqli_fetch_array($query)){
                ...
                <form action="edit4.php?action=order" method="POST">
  ...
  <select name="jroom" onchange="kamar()" id="jroom" class="inputan">
  <option></option>
  ...
  <select id="pilihkamar" name="idkamar" class="inputan">
<option></option>
</select><br>
...
function kamar(){
            var jenis = $('#jroom').val();
            $.ajax({
                url : "edit4.php?action=getkamar&&jenis="+jenis,
                type : "GET",
                dataType : "JSON",
