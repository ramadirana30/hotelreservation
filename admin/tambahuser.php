...
$result = mysqli_query($koneksi, "SELECT * FROM tbl_user ORDER BY id_user DESC");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb" style="width:100%;">
				...
				<li class="active">Dashboard</li><li class="active">Tambah Data</li>
			</ol>
		</div><!--/.row-->
  ...
  <input class="inputan" type="text" id="email" name="email" ><br>
  <div class="text">Password :</div>
  <input class="inputan" type="password" id="password" name="password" ><br>
  <div class="text">Nama :</div>
  <input class="inputan" type="text" id="nama" name="nama" ><br>
  <div class="text">Alamat :</div>
  <input class="inputan" type="text" id="alamat" name="alamat" ><br>
