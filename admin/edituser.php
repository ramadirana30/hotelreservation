...
<body>
  ...
  <input class="inputan" type="text" id="email" name="email" value="<?= $d['email']; ?>"><br>
  <div class="text">Password :</div>
  <input class="inputan" type="password" id="password" name="password" value="<?= $d['password']; ?>"><br>
  <div class="text">Nama :</div>
  <input class="inputan" type="text" id="nama" name="nama" value="<?= $d['nama']; ?>"><br>
  <div class="text">Alamat :</div>
  <input class="inputan" type="text" id="alamat" name="alamat" value="<?= $d['alamat']; ?>"><br>
