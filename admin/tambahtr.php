...
<body>
    ...
    <form action="laporanpro.php?action=order" method="POST">
  <div class="text">Nama :</div>
  <input class="inputan" type="text" id="nama" name="nama" required><br>
  <div class="text">Kode Booking :</div>
  <input class="inputan" type="text" id="kdbooking" name="kdbooking" required><br>
  <div class="text">Tanggal Bayar :</div>
  <input class="inputan" type="date"  min="2019-01-01" max="2019-12-31" id="tglbayar" name="tglbayar" required><br>
  <div class="text">Harga :</div>
  <input class="inputan" type="text" id="harga" name="harga" required><br>
<br><br>
