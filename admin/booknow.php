...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
                <h1 class="page-header">Booknow (Room and Meeting)</h1>
            ...
            <?php  
             while($user_data = mysqli_fetch_array($result)) { 
                ...
                echo "<td>".$user_data['id_jenis']."</td>";
                echo "<td>".$user_data['tipe_jenis']."</td>"; 
                echo "<td>".$user_data['tgl_checkin']."</td>";
                echo "<td>".$user_data['tgl_checkout']."</td>";
                echo "<td>".$user_data['days']."</td>"; 
                echo "<td>".$user_data['harga']."</td>";
                echo "<td>".$user_data['total']."</td>";    
                echo "<td>".$user_data['kd_booking']."</td>";  
                echo "<td>".$user_data['status']."</td>"; 
                echo "<td><a class='btn btn-success' href='edit1.php?id=$user_data[id_booking]'>Edit</a> <a class='btn btn-success' href='delete1.php?id=$user_data[id_booking]'>Delete</a>"; 
                echo "<td><a class='btn btn-success' href='edit3.php?id=$user_data[id_booking]'>Edit</a> <a class='btn btn-success' href='delete1.php?id=$user_data[id_booking]'>Delete</a>"; 
                echo "<td><a class='btn btn-success' href='status.php?id=$user_data[id_booking]'>Status</a>'</td>";
       ...
       <input type="button" onclick="location.href='tambah1.php'" class="btn btn-success" value="TAMBAH MEETING">
       <input type="button" onclick="location.href='tambah3.php'" class="btn btn-success" value="TAMBAH ROOM">
			</div>
		</div>
