	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<thead class="thead-dark" >
				<tr>
                <th>ID_User</th> <th>Email</th> <th>Password</th> <th>Nama</th>
        ...
        echo "<td>".$user_data['alamat']."</td>";
                echo "<td><a class='btn btn-success' href='edituser.php?id=$user_data[id_user]'>Edit</a> <a class='btn btn-success' href='deleteuser.php?id=$user_data[id_user]'>Delete</a>"; 
       ...
       <input type="button" onclick="location.href='tambahuser.php'" class="btn btn-success" value="TAMBAH USER">
			</div>
		</div>
