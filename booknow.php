...
<br><center>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="roomuser.php">BOOKING</a></button></center>
</div>
    <div class="col-xs-4 col-sm-4 col-lg-4" style="background-color:white; height:950px;">
    <div class="card">
        <input type="checkbox" name="">
...
<br><center>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="restaurant.php">BOOKING</a></button></center>
</div>
    <div class="col-xs-4 col-sm-4 col-lg-4" style="background-color:white; height:950px;">
    <div class="card">
        <input type="checkbox" name="">
...
<br><center>
<button type="button" class="btn btn-default"><a style="text-decoration:none; color:black;" href="meetinguser.php">BOOKING</a></button></center>
</div>
</div>
<div class="row" >
