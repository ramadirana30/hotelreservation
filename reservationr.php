...
<div class="row" >
    <div class="col-xs-12 col-sm-12 col-lg-12" style="background-color:white; height:200px; color : black; font-family : times new roman; font-size : 70px; text-align: center; margin-top : 150px;">MY RESERVATION RESTAURANT<hr style=" border: 2px solid black;"></div>
</div>
<div class="row" >
...
$id_user = $_SESSION['id'];
$reservation = "SELECT id_bookingresto, nama_lengkap, waktu_pesanan, jenis,keterangan, tgl_makan,kd_booking,status
		FROM tbl_bookingresto WHERE id_user='$id_user'";
...
<tr class="w3-grey" >
  ...
  <th style="color:black;">WAKTU PESANAN</th>
  <th style="color:black;">JENIS</th>
  <th style="color:black;">KETERANGAN</th>
  <th style="color:black;">TANGGAL MAKAN</th>
  ...
  <th style="color:black;">STATUS</th>
    ...
    while ($row = mysqli_fetch_array($q1))
    {
      echo '<tr>
          ...
          <td style="color:black;">'.$row['waktu_pesanan'].'</td>
          <td style="color:black;">'.$row['jenis'].'</td>
          <td style="color:black;">'.$row['keterangan'].'</td>
          <td style="color:black;">'.$row['tgl_makan'].'</td>
